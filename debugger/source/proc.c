...
size_t proc_scan_getSizeOfValueType(cmd_proc_scan_valuetype valType) {
    switch (valType) {
       ...
       case SCAN_VAL_U64:
       case SCAN_VAL_S64:
       case SCAN_VAL_DOUBLE:
          return 8;
       case SCAN_VAL_BYTE_ARRAY:
       case SCAN_VAL_STRING:
       default:
          return NULL;
    }
}
